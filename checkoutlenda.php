...
<nav class="navbar navbar-inverse navbar-fixed-top">
	...
	<span class="icon-bar"></span>
				...
				<a class="navbar-brand" href="index.php">Lendas Urbanas</a>
			</div>
...
<li class="active"><a href="sobre.php">Sobre</a></li>
		...
		<div	class="jumbotron">
					<div	class="container">
					<h1>Ótima	escolha!</h1>
					<p>Obrigado	por	comprar	na	Lendas Urbanas Shop
...
<div class="panel-heading">
									...
									<img src="img/produtos/funco1-<?= $_POST['cor'] ?>.png" class="img-thumbnail img-responsive">
					...
					<legend>Dados pessoais</legend>
							...
							<div class="checkbox">
								<label>
									...
									Quero receber spam da Lendas Urbanas Shop
								</label>
							</div>
						</fieldset>
						<fieldset class="col-md-6">
